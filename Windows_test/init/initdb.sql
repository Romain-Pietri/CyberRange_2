...
-- Ajouter une connexion pour Kali Blue
INSERT INTO guacamole_connection (connection_name, protocol) VALUES ('Kali Blue', 'rdp');
INSERT INTO guacamole_connection_parameter (connection_id, parameter_name, parameter_value)
VALUES (
    (SELECT connection_id FROM guacamole_connection WHERE connection_name = 'Kali Blue'),
    'hostname',
    'kali_blue1' -- Correspond exactement au nom du conteneur
), (
    (SELECT connection_id FROM guacamole_connection WHERE connection_name = 'Kali Blue'),
    'port',
    '3389'
